    ...
    <div class="w-full m-0 p-0">
        <div class="bg-white rounded-b-lg shadow-sm overflow-hidden w-full">
            ...
            <div class="max-w-screen-xl mx-auto px-6 py-6">
                <form action="{{ route('qc.cmr.store') }}" method="POST" enctype="multipart/form-data" id="cmr-form">
                    @csrf
                    ...
                    <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                        <div>
                            ...
                            <select name="cmr_type" id="cmr_type" required
                                ...
                                <option value="4W" {{ old('cmr_type', '4W') == '4W' ? 'selected' : '' }}>4W</option>
                                <option value="2W" {{ old('cmr_type') == '2W' ? 'selected' : '' }}>2W</option>
                            </select>
                        </div>
                    ...
                    <div class="form-compact">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <input type="hidden" name="tgl_terbit_cmr" id="tgl_terbit_cmr"
                                    value="{{ old('tgl_terbit_cmr') ? (is_string(old('tgl_terbit_cmr')) && strtotime(old('tgl_terbit_cmr')) ? date('Y-m-d', strtotime(old('tgl_terbit_cmr'))) : old('tgl_terbit_cmr')) : '' }}"
                                    required>
                                <input type="text" name="tgl_terbit_cmr_display" id="tgl_terbit_cmr_display"
                                    ...
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="{{ old('tgl_terbit_cmr') ? ((strpos(old('tgl_terbit_cmr'), '-') !== false && strtotime(old('tgl_terbit_cmr'))) ? date('d-m-Y', strtotime(old('tgl_terbit_cmr'))) : str_replace('/', '-', old('tgl_terbit_cmr'))) : '' }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <input type="hidden" name="bl_date" id="bl_date"
                                    value="{{ old('bl_date') ? (is_string(old('bl_date')) && strtotime(old('bl_date')) ? date('Y-m-d', strtotime(old('bl_date'))) : old('bl_date')) : '' }}">
                                <input type="text" name="bl_date_display" id="bl_date_display" inputmode="numeric"
                                    pattern="\d{2}-\d{2}-\d{4}" placeholder="dd-mm-yyyy"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="{{ old('bl_date') ? ((strpos(old('bl_date'), '-') !== false && strtotime(old('bl_date'))) ? date('d-m-Y', strtotime(old('bl_date'))) : str_replace('/', '-', old('bl_date'))) : '' }}">
                                @error('bl_date')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="hidden" name="ar_date" id="ar_date"
                                    value="{{ old('ar_date') ? (is_string(old('ar_date')) && strtotime(old('ar_date')) ? date('Y-m-d', strtotime(old('ar_date'))) : old('ar_date')) : '' }}">
                                <input type="text" name="ar_date_display" id="ar_date_display" inputmode="numeric"
                                    pattern="\d{2}-\d{2}-\d{4}" placeholder="dd-mm-yyyy"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="{{ old('ar_date') ? ((strpos(old('ar_date'), '-') !== false && strtotime(old('ar_date'))) ? date('d-m-Y', strtotime(old('ar_date'))) : str_replace('/', '-', old('ar_date'))) : '' }}">
                                @error('ar_date')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <input type="hidden" name="found_date" id="found_date"
                                    value="{{ old('found_date') ? (is_string(old('found_date')) && strtotime(old('found_date')) ? date('Y-m-d', strtotime(old('found_date'))) : old('found_date')) : '' }}">
                                <input type="text" name="found_date_display" id="found_date_display" inputmode="numeric"
                                    pattern="\d{2}-\d{2}-\d{4}" placeholder="dd-mm-yyyy"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="{{ old('found_date') ? ((strpos(old('found_date'), '-') !== false && strtotime(old('found_date'))) ? date('d-m-Y', strtotime(old('found_date'))) : str_replace('/', '-', old('found_date'))) : '' }}">
                                @error('found_date')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">ORDER NO (|オーダーNo.) <span
                                        class="text-red-500">*</span></label>
                                <input name="order_no" value="{{ old('order_no') }}" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <select name="product" required
                                    ...
                                    <option value="SKA" {{ old('product') == 'SKA' ? 'selected' : '' }}>SKA</option>
                                    <option value="FF" {{ old('product') == 'FF' ? 'selected' : '' }}>FF</option>
                                    <option value="OCU" {{ old('product') == 'OCU' ? 'selected' : '' }}>OCU</option>
                                </select>
                            ...
                            <div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input name="crate_number" value="{{ old('crate_number') }}"
                                        class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                ...
                                <select name="location_claim_occurrence" id="lokasi_penemuan_claim" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="Receiving Inspect" {{ old('location_claim_occurrence') == 'Receiving Inspect' ? 'selected' : '' }}>Receiving Inspect (受入检查)</option>
                                    <option value="In-Process" {{ old('location_claim_occurrence') == 'In-Process' ? 'selected' : '' }}>In-Process (工程内)</option>
                                    <option value="Customer" {{ old('location_claim_occurrence') == 'Customer' ? 'selected' : '' }}>Customer (客先)</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <select name="disposition_inventory_type" id="disposition_inventory_type" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="AT CUSTOMER" {{ old('disposition_inventory_type') == 'AT CUSTOMER' ? 'selected' : '' }}>AT CUSTOMER (客先にて)</option>
                                    <option value="AT PT.KYBI" {{ old('disposition_inventory_type') == 'AT PT.KYBI' ? 'selected' : '' }}>AT PT.KYBI (PT KYB にて)</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <select name="claim_occurrence_frequency" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="First time" {{ old('claim_occurrence_frequency') == 'First time' ? 'selected' : '' }}>First time (初回)</option>
                                    <option value="Reoccurred" {{ old('claim_occurrence_frequency') == 'Reoccurred' ? 'selected' : '' }}>Reoccurred (再発)</option>
                                    <option value="Intermittently" {{ old('claim_occurrence_frequency') == 'Intermittently' ? 'selected' : '' }}>Intermittently (断統的)</option>
                                    <option value="Continuously" {{ old('claim_occurrence_frequency') == 'Continuously' ? 'selected' : '' }}>Continuously (總統的)</option>
                                    <option value="Other" {{ old('claim_occurrence_frequency') == 'Other' ? 'selected' : '' }}>Other (その他)</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
                            ...
                            <div>
                                ...
                                <select name="dispatch_defective_parts" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="Dispatch with this report" {{ old('dispatch_defective_parts') == 'Dispatch with this report' ? 'selected' : '' }}>Dispatch with this report (本レポートと共に送付)
                                    </option>
                                    <option value="Dispatch separately" {{ old('dispatch_defective_parts') == 'Dispatch separately' ? 'selected' : '' }}>Dispatch separately (別途送付)</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <select name="disposition_defect_parts" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="Keep to use" {{ old('disposition_defect_parts') == 'Keep to use' ? 'selected' : '' }}>Keep to use (總統使用)</option>
                                    <option value="Return to KYB" {{ old('disposition_defect_parts') == 'Return to KYB' ? 'selected' : '' }}>Return to KYB (KYB 返却)</option>
                                    <option value="Scrapped at PT.KYB" {{ old('disposition_defect_parts') == 'Scrapped at PT.KYB' ? 'selected' : '' }}>Scrapped at PT.KYB (PTKYB にて廃却)</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">QTY ORDER (注文数量)<span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="qty_order" value="{{ old('qty_order') }}" required min="0"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">QTY DELIVERED (納品数量)<span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="qty_deliv" value="{{ old('qty_deliv') }}" required min="0"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">QTY PROBLEM (数量の問題)<span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="qty_problem" value="{{ old('qty_problem') }}" required min="0"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                        ...
                        <div class="mb-6">
                            ...
                            <input name="input_problem" id="input_problem" value="{{ old('input_problem') }}" type="text"
                                maxlength="75"
                                class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            try {
                ...
                function renderChoices() { const val = type ? type.value : ''; if (!choice) return; choice.innerHTML = '<option value="">--Choose --</option>'; if (options[val]) options[val].forEach(o => { const el = document.createElement('option'); el.value = o[0]; el.textContent = o[1]; if ("{{ old('disposition_inventory_choice') }}" === o[0]) el.selected = true; choice.appendChild(el); }); }
