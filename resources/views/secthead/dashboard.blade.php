...
@section('title', 'Sect Head Dashboard')
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl md:text-3xl font-bold text-blue-600">{{ number_format($lpkStats['total']) }}
                        </p>
                        <div class="flex items-center mt-2 text-sm">
                            <span class="text-green-600 font-medium">+{{ $lpkStats['approved'] }}</span>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl md:text-3xl font-bold text-purple-600">
                            {{ number_format($nqrStats['total']) }}
                        </p>
                        <div class="flex items-center mt-2 text-sm">
                            <span class="text-green-600 font-medium">+{{ $nqrStats['completed'] }}</span>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl md:text-3xl font-bold text-orange-600">
                            {{ number_format($cmrStats['total']) }}
                        </p>
                        <div class="flex items-center mt-2 text-sm">
                            <span class="text-green-600 font-medium">+{{ $cmrStats['completed'] }}</span>
                            <span class="text-gray-500 ml-1">completed</span>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl md:text-3xl font-bold text-gray-900">
                            {{ number_format($lpkStats['total'] + $nqrStats['total'] + $cmrStats['total']) }}
                        </p>
                        <div class="flex items-center mt-2 text-sm">
                            <span
                                class="text-yellow-600 font-medium">{{ $lpkStats['pending'] + $nqrStats['pending'] + $cmrStats['pending'] }}</span>
                    ...
                    <div class="w-10 h-10 md:w-12 md:h-12 bg-red-100 rounded-lg flex items-center justify-center">
                        <img src="{{ asset('image/chart.png') }}" alt="Document Icon"
                            class="w-5 h-5 md:w-6 md:h-6 object-contain">
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-2 md:mb-0">
                            ...
                            @section('title', 'Sect Head Dashboard')
                                ...
                                @section('content')
                                        ...
                                        <div class="max-w-7xl mx-auto">
                                            <div
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div>
                                                            ...
                                                            <p class="text-2xl md:text-3xl font-bold text-blue-600">
                                                                {{ number_format($lpkStats['total']) }}
                                                            </p>
                                                            <div class="flex items-center mt-2 text-sm">
                                                                <span
                                                                    class="text-green-600 font-medium">+{{ $lpkStats['approved'] }}</span>
                                                                <span class="text-gray-500 ml-1">approved</span>
                                                            </div>
                                                        </div>
                                                        <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div>
                                                            ...
                                                            <div class="flex items-center mt-2 text-sm">
                                                                <span
                                                                    class="text-green-600 font-medium">+{{ $nqrStats['completed'] }}</span>
                                                                <span class="text-gray-500 ml-1">completed</span>
                                                            </div>
                                                        </div>
                                                        <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div>
                                                            ...
                                                            <div class="flex items-center mt-2 text-sm">
                                                                <span
                                                                    class="text-green-600 font-medium">+{{ $cmrStats['completed'] }}</span>
                                                                <span class="text-gray-500 ml-1">completed</span>
                                                            </div>
                                                        </div>
                                                        <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div>
                                                            <p class="text-sm font-medium text-gray-500 mb-1">Total Documents
                                                            </p>
                                                            <p class="text-2xl md:text-3xl font-bold text-gray-900">
                                                                {{ number_format($lpkStats['total'] + $nqrStats['total'] + $cmrStats['total']) }}
                                                            </p>
                                            ...
                                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-4 md:mb-6">
                                                <div
                                                    class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-green-500 p-4 md:p-6">
                                                    <div
                                                        class="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 md:mb-6 space-y-4 md:space-y-0">
                                                        <div
                                                            class="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-4 w-full md:w-auto">
                                                            <h3 class="text-base md:text-lg font-semibold text-gray-900">Monthly
                                                                Document Trends</h3>
                                                            <div class="flex items-center space-x-2">
                                                                <label for="yearFilter"
                                                                    class="text-sm font-medium text-gray-600">Year:</label>
                                                                <select id="yearFilter"
                                                                    class="px-2 py-1 md:px-3 md:py-1 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                                    @php
                                                                        $currentYear = date('Y');
                                                            ...
                                                            <div class="flex items-center space-x-2">
                                                                <label for="monthFilter"
                                                                    class="text-sm font-medium text-gray-600">Month:</label>
                                                                <select id="monthFilter"
                                                                    class="px-2 py-1 md:px-3 md:py-1 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                                                    <option value="">All</option>
                                                                    @php
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex items-center mb-2 md:mb-0">
                                                                <div
                                                                    class="w-2 h-2 md:w-3 md:h-3 bg-blue-500 rounded-full mr-1 md:mr-2">
                                                                </div>
                                                                <span class="text-gray-600">LPK</span>
                                                            </div>
                                                            <div class="flex items-center mb-2 md:mb-0">
                                                                <div
                                                                    class="w-2 h-2 md:w-3 md:h-3 bg-purple-500 rounded-full mr-1 md:mr-2">
                                                                </div>
                                                                <span class="text-gray-600">NQR</span>
                                                            </div>
                                                            <div class="flex items-center mb-2 md:mb-0">
                                                                <div
                                                                    class="w-2 h-2 md:w-3 md:h-3 bg-orange-500 rounded-full mr-1 md:mr-2">
                                                                </div>
                                                    ...
                                                    <div
                                                        class="flex flex-wrap items-center gap-3 md:gap-4 text-xs md:text-sm mb-4">
                                                        <span class="text-gray-500 font-medium">Trend:</span>
                                                        <div class="flex items-center">
                                                            <div class="w-6 h-0.5 mr-1.5"
                                                                style="border-top: 2px dashed #3b82f6;"></div>
                                                            <span class="text-gray-600">LPK</span>
                                                        </div>
                                                        <div class="flex items-center">
                                                            <div class="w-6 h-0.5 mr-1.5"
                                                                style="border-top: 2px dashed #9333ea;"></div>
                                                            <span class="text-gray-600">NQR</span>
                                                        </div>
                                                        <div class="flex items-center">
                                                            <div class="w-6 h-0.5 mr-1.5"
                                                                style="border-top: 2px dashed #f97316;"></div>
                                                            <span class="text-gray-600">CMR</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="relative h-64 sm:h-72 md:h-80">
                                                        <div id="chartLoading"
                                                            ...
                                                            <div class="flex items-center space-x-2">
                                                                <div
                                                                    class="animate-spin rounded-full h-5 w-5 md:h-6 md:w-6 border-b-2 border-blue-600">
                                                                </div>
                                                                <span class="text-xs md:text-sm text-gray-600">Loading
                                                                    chart...</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="bg-white rounded-xl shadow-sm border border-green-500 p-4 md:p-6">
                                                    <div class="flex items-center justify-between mb-4 md:mb-6">
                                                        <h3 class="text-base md:text-lg font-semibold text-gray-900">Status
                                                            Distribution</h3>
                                                    </div>
                                                    ...
                                                    <div class="mt-4 space-y-2 text-xs md:text-sm">
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div
                                                                    class="w-2 h-2 md:w-3 md:h-3 bg-green-500 rounded-full mr-1 md:mr-2">
                                                                </div>
                                                                <span class="text-gray-600">Approved/Completed</span>
                                                            </div>
                                                            <span
                                                                class="font-semibold text-gray-900">{{ $statusDistribution['approved'] }}</span>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div
                                                                    class="w-2 h-2 md:w-3 md:h-3 bg-yellow-500 rounded-full mr-1 md:mr-2">
                                                                </div>
                                                                <span class="text-gray-600">Pending</span>
                                                            </div>
                                                            <span
                                                                class="font-semibold text-gray-900">{{ $statusDistribution['pending'] }}</span>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div
                                                                    class="w-2 h-2 md:w-3 md:h-3 bg-red-500 rounded-full mr-1 md:mr-2">
                                                                </div>
                                                                <span class="text-gray-600">Rejected</span>
                                                            </div>
                                                            <span
                                                                class="font-semibold text-gray-900">{{ $statusDistribution['rejected'] }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                                                <div class="bg-white rounded-xl shadow-sm border border-blue-500 p-4 md:p-6">
                                                    <h3 class="text-base md:text-lg font-semibold text-gray-900 mb-3 md:mb-4">
                                                        LPK Status Details</h3>
                                                    <div class="space-y-2 md:space-y-3">
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-green-100 rounded-lg">
                                                            <div class="flex items-center">
                                                                <div class="w-2 h-2 bg-green-500 rounded-full mr-2 md:mr-3">
                                                                </div>
                                                                <span
                                                                    class="text-xs md:text-sm font-medium text-gray-700">Approved</span>
                                                            </div>
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-green-600">{{ $lpkStats['approved'] }}</span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-yellow-100 rounded-lg">
                                                            <div class="flex items-center">
                                                                <div class="w-2 h-2 bg-yellow-500 rounded-full mr-2 md:mr-3">
                                                                </div>
                                                                <span
                                                                    class="text-xs md:text-sm font-medium text-gray-700">Pending</span>
                                                            </div>
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-yellow-600">{{ $lpkStats['pending'] }}</span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-red-100 rounded-lg">
                                                            <div class="flex items-center">
                                                                <div class="w-2 h-2 bg-red-500 rounded-full mr-2 md:mr-3"></div>
                                                                <span
                                                                    class="text-xs md:text-sm font-medium text-gray-700">Rejected</span>
                                                            </div>
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-red-600">{{ $lpkStats['rejected'] }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="space-y-2 md:space-y-3">
                                                        <div
                                                            ...
                                                            <div class="flex items-center">
                                                                ...
                                                                <span
                                                                    class="text-xs md:text-sm font-medium text-gray-700">Completed</span>
                                                            </div>
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-green-600">{{ $nqrStats['completed'] }}</span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-yellow-100 rounded-lg">
                                                            <div class="flex items-center">
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-yellow-600">{{ $nqrStats['pending'] }}</span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-red-100 rounded-lg">
                                                            <div class="flex items-center">
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-red-600">{{ $nqrStats['rejected'] }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="bg-white rounded-xl shadow-sm border border-orange-500 p-4 md:p-6">
                                                    ...
                                                    <div class="space-y-2 md:space-y-3">
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-green-600">{{ $cmrStats['completed'] }}</span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-yellow-100 rounded-lg">
                                                            <div class="flex items-center">
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-yellow-600">{{ $cmrStats['pending'] }}</span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-red-100 rounded-lg">
                                                            <div class="flex items-center">
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-red-600">{{ $cmrStats['rejected'] }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function () {
                                            ...
                                            const lpkData = {!! json_encode($monthlyData['lpk']) !!};
                                            const nqrData = {!! json_encode($monthlyData['nqr']) !!};
                                            const cmrData = {!! json_encode($monthlyData['cmr']) !!};
                                            ...
                                            function fetchAndUpdateChart(year, month = null) {
                                                ...
                                                fetch(`{{ route('dashboard.monthlyData') }}?` + params.toString(), {
                                                    method: 'GET',
                                                    headers: {
                                ...
                                const distFromCenter = Math.hypot(x - arc.x, y - arc.y);
                                const minLabelGap = 12;
                                if (innerR > 0 && distFromCenter <= innerR + minLabelGap) return; ctx.textAlign='center' ;
                                    ctx.textBaseline='middle' ; ctx.fillStyle='#ffffff' ;
                                    ctx.font='600 10px ui-sans-serif, system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial'
                                    ; ctx.fillText(value.toLocaleString(), x, y - 6); const percentage=total> 0 ?
                                    Math.round((value / total) * 100) : 0;
                                    ctx.font = '500 9px ui-sans-serif, system-ui, -apple-system, "Segoe UI", Roboto,
                                    ...
                                    monthlyChart.data.datasets[0].data = data.lpk;
                                    monthlyChart.data.datasets[1].data = data.nqr;
                                    monthlyChart.data.datasets[2].data = data.cmr;
