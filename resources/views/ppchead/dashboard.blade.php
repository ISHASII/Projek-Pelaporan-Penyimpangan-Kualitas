...
@section('title', 'Dept Head Dashboard')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-green-500 p-4 md:p-6">
                    ...
                    <div class="mt-4 space-y-2 text-xs md:text-sm">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-semibold text-gray-900">{{ $statusDistribution['approved'] }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                            ...
                            <span class="font-semibold text-gray-900">{{ $statusDistribution['pending'] }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                            ...
                            <span class="font-semibold text-gray-900">{{ $statusDistribution['rejected'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-blue-500 p-4 md:p-6">
                    ...
                    <div class="space-y-2 md:space-y-3">
                        <div class="flex items-center justify-between p-2 md:p-3 bg-green-100 rounded-lg">
                            ...
                            <span class="text-xs md:text-sm font-bold text-green-600">{{ $lpkStats['approved'] }}</span>
                        </div>
                        <div class="flex items-center justify-between p-2 md:p-3 bg-yellow-100 rounded-lg">
                            ...
                            <span class="text-xs md:text-sm font-bold text-yellow-600">{{ $lpkStats['pending'] }}</span>
                        </div>
                        <div class="flex items-center justify-between p-2 md:p-3 bg-red-100 rounded-lg">
                            ...
                            <span class="text-xs md:text-sm font-bold text-red-600">{{ $lpkStats['rejected'] }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-purple-500 p-4 md:p-6">
                    ...
                    <div class="space-y-2 md:space-y-3">
                        <div class="flex items-center justify-between p-2 md:p-3 bg-green-100 rounded-lg">
                            ...
                            <span class="text-xs md:text-sm font-bold text-green-600">{{ $nqrStats['completed'] }}</span>
                        </div>
                        <div class="flex items-center justify-between p-2 md:p-3 bg-yellow-100 rounded-lg">
                            <div class="flex items-center">
                                <div class="w-2 h-2 bg-yellow-500 rounded-full mr-2 md:mr-3"></div>
                            ...
                            <span class="text-xs md:text-sm font-bold text-yellow-600">{{ $nqrStats['pending'] }}</span>
                        </div>
                        <div class="flex items-center justify-between p-2 md:p-3 bg-red-100 rounded-lg">
                            <div class="flex items-center">
                                <div class="w-2 h-2 bg-red-500 rounded-full mr-2 md:mr-3"></div>
                            ...
                            <span class="text-xs md:text-sm font-bold text-red-600">{{ $nqrStats['rejected'] }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-orange-500 p-4 md:p-6">
                    ...
                    <div class="space-y-2 md:space-y-3">
                        <div class="flex items-center justify-between p-2 md:p-3 bg-green-100 rounded-lg">
                            ...
                            <span class="text-xs md:text-sm font-bold text-green-600">{{ $cmrStats['completed'] }}</span>
                        </div>
                        <div class="flex items-center justify-between p-2 md:p-3 bg-yellow-100 rounded-lg">
                            <div class="flex items-center">
                                <div class="w-2 h-2 bg-yellow-500 rounded-full mr-2 md:mr-3"></div>
                            ...
                            <span class="text-xs md:text-sm font-bold text-yellow-600">{{ $cmrStats['pending'] }}</span>
                        </div>
                        <div class="flex items-center justify-between p-2 md:p-3 bg-red-100 rounded-lg">
                            <div class="flex items-center">
                                <div class="w-2 h-2 bg-red-500 rounded-full mr-2 md:mr-3"></div>
                            ...
                            <span class="text-xs md:text-sm font-bold text-red-600">{{ $cmrStats['rejected'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
