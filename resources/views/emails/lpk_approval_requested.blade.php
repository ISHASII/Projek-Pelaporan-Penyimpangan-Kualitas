...
<body>
    ...
    <div class="content">
        ...
        <table class="info-table">
            <tr>
                <td>No. Registrasi</td>
                <td><strong>{{ $lpk->no_reg }}</strong></td>
            </tr>
            <tr>
                <td>Tanggal Terbit</td>
                <td>{{ $lpk->tgl_terbit ? \Carbon\Carbon::parse($lpk->tgl_terbit)->format('d/m/Y') : '-' }}</td>
            </tr>
            <tr>
                <td>Supplier</td>
                <td>{{ $lpk->nama_supply ?? '-' }}</td>
            </tr>
            <tr>
                <td>Nama Part</td>
                <td>{{ $lpk->nama_part ?? '-' }}</td>
            ...
            <tr>
                ...
                <td>
                    <span
                        class="status-badge {{ strtolower($lpk->status ?? '') === 'claim' ? 'status-claim' : 'status-complaint' }}">
                        {{ $lpk->status ?? 'N/A' }}
                    </span>
                </td>
            </tr>
