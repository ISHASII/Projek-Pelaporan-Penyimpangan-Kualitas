        ...
        <div class="m-0">
            <div
                ...
                <div class="p-6">
                    ...
                    <form id="filter-form" method="GET" action="{{ route('vdd.nqr.index') }}" class="mb-4">
                        @php
                            $dateValue = '';
                            if (request('date')) {
                                try {
                                                                    ...
                                                                    <div class="flex items-center justify-center gap-1 action-buttons-container">
                                                                        @if($nqr->status_approval === 'Menunggu Approval VDD')
                                                                            <div class="flex flex-col items-center">
                                                                                <a href="{{ route('vdd.nqr.inputPayCompensation', $nqr->id) }}"
                                                                            ...
                                                                            <div class="flex flex-col items-center">
                                                                                <button type="button"
                                                                                    data-url="{{ route('vdd.nqr.reject', $nqr->id) }}"
                                                                        ...
                                                                        @if(
                                                                            ...
                                                                            <div class="flex flex-col items-center">
                                                                                <a href="{{ route('vdd.nqr.previewFpdf', $nqr->id) }}" target="_blank"
