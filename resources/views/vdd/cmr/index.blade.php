                                                    ...
                                                    <div class="flex items-center justify-center gap-4 action-buttons-container">
                                                        ...
                                                        @if(!is_null($cmr->requested_at_qc) && strtolower($cmr->ppchead_status ?? '') === 'approved' && $vddStatus === 'pending')
                                                            <div class="flex flex-col items-center gap-1">
                                                                <button type="button" class="open-approve-modal inline-flex items-center justify-center w-8 h-8 rounded-md hover:bg-green-50" title="Approve" data-url="{{ route('vdd.cmr.approve', $cmr->id) }}" data-noreg="{{ $cmr->no_reg }}">
