<?php $__env->startSection('title', 'Sect Head Dashboard'); ?>
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div>
                                                            ...
                                                            <p class="text-2xl md:text-3xl font-bold text-blue-600">
                                                                <?php echo e(number_format($lpkStats['total'])); ?>

                                                            </p>
                                                            <div class="flex items-center mt-2 text-sm">
                                                                <span
                                                                    class="text-green-600 font-medium">+<?php echo e($lpkStats['approved']); ?></span>
                                                                <span class="text-gray-500 ml-1">approved</span>
                                                            </div>
                                                        </div>
                                                        <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div>
                                                            ...
                                                            <div class="flex items-center mt-2 text-sm">
                                                                <span
                                                                    class="text-green-600 font-medium">+<?php echo e($nqrStats['completed']); ?></span>
                                                                <span class="text-gray-500 ml-1">completed</span>
                                                            </div>
                                                        </div>
                                                        <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div>
                                                            ...
                                                            <div class="flex items-center mt-2 text-sm">
                                                                <span
                                                                    class="text-green-600 font-medium">+<?php echo e($cmrStats['completed']); ?></span>
                                                                <span class="text-gray-500 ml-1">completed</span>
                                                            </div>
                                                        </div>
                                                        <div
                                                ...
                                                <div class="bg-white rounded-xl shadow-sm border border-green-500 p-4 md:p-6">
                                                    ...
                                                    <div class="mt-4 space-y-2 text-xs md:text-sm">
                                                        <div class="flex items-center justify-between">
                                                            ...
                                                            <span
                                                                class="font-semibold text-gray-900"><?php echo e($statusDistribution['approved']); ?></span>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div
                                                            ...
                                                            <span
                                                                class="font-semibold text-gray-900"><?php echo e($statusDistribution['pending']); ?></span>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                            <div class="flex items-center">
                                                                <div
                                                            ...
                                                            <span
                                                                class="font-semibold text-gray-900"><?php echo e($statusDistribution['rejected']); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="bg-white rounded-xl shadow-sm border border-blue-500 p-4 md:p-6">
                                                    ...
                                                    <div class="space-y-2 md:space-y-3">
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-green-600"><?php echo e($lpkStats['approved']); ?></span>
                                                        </div>
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-yellow-600"><?php echo e($lpkStats['pending']); ?></span>
                                                        </div>
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-red-600"><?php echo e($lpkStats['rejected']); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="bg-white rounded-xl shadow-sm border border-purple-500 p-4 md:p-6">
                                                    ...
                                                    <div class="space-y-2 md:space-y-3">
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-green-600"><?php echo e($nqrStats['completed']); ?></span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-yellow-100 rounded-lg">
                                                            <div class="flex items-center">
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-yellow-600"><?php echo e($nqrStats['pending']); ?></span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-red-100 rounded-lg">
                                                            <div class="flex items-center">
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-red-600"><?php echo e($nqrStats['rejected']); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="bg-white rounded-xl shadow-sm border border-orange-500 p-4 md:p-6">
                                                    ...
                                                    <div class="space-y-2 md:space-y-3">
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-green-600"><?php echo e($cmrStats['completed']); ?></span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-yellow-100 rounded-lg">
                                                            <div class="flex items-center">
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-yellow-600"><?php echo e($cmrStats['pending']); ?></span>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-between p-2 md:p-3 bg-red-100 rounded-lg">
                                                            <div class="flex items-center">
                                                            ...
                                                            <span
                                                                class="text-xs md:text-sm font-bold text-red-600"><?php echo e($cmrStats['rejected']); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/secthead/dashboard.blade.php ENDPATH**/ ?>