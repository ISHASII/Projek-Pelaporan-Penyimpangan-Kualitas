<?php $__env->startSection('content'); ?>
    ...
    <div id="approve-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40">
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
            ...
            <!-- Recipient Selection for Procurement -->
            <div class="mb-4">
                ...
                <div class="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto border rounded p-2 bg-white">
                    <?php $__empty_1 = true; $__currentLoopData = $procurementApprovers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                            <input type="checkbox" name="approve_recipients[]" value="<?php echo e($pa->npk); ?>" class="approve-recipient-checkbox">
                ...
                <div class="text-xs text-gray-500 mt-1">Kosongkan jika tidak ingin meneruskan ke Procurement secara spesifik.</div>
            </div>
