        ...
        <div class="bg-white shadow rounded-lg overflow-hidden mt-6">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center mb-8 gap-3">
                        ...
                        <?php if(!empty($lpk->id)): ?>
                            <a href="<?php echo e(route('ppchead.lpk.downloadPdf', $lpk->id)); ?>" target="_blank" rel="noopener"
                ...
                <div class="mb-6 rounded-lg border border-gray-200 bg-white shadow-sm p-4">
                    ...
                    <div class="grid grid-cols-1 gap-2 text-sm text-gray-700 sm:grid-cols-2 lg:grid-cols-3">
                        <div>
                            ...
                            <div class="font-medium"><?php echo e($lpk->referensi_lka ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Tgl Terbit LKA</div>
                            <div class="font-medium"><?php echo e($lpk->tgl_terbit_lka ? (is_string($lpk->tgl_terbit_lka) ? (strtotime($lpk->tgl_terbit_lka) ? date('d-m-Y', strtotime($lpk->tgl_terbit_lka)) : $lpk->tgl_terbit_lka) : $lpk->tgl_terbit_lka->format('d-m-Y')) : '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Tgl Terbit LPK</div>
                            <div class="font-medium"><?php echo e($lpk->tgl_terbit ? (is_string($lpk->tgl_terbit) ? (strtotime($lpk->tgl_terbit) ? date('d-m-Y', strtotime($lpk->tgl_terbit)) : $lpk->tgl_terbit) : $lpk->tgl_terbit->format('d-m-Y')) : (optional($lpk->created_at)->format('d-m-Y') ?? '-')); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Tgl Delivery</div>
                            <div class="font-medium"><?php echo e($lpk->tgl_delivery ? (is_string($lpk->tgl_delivery) ? (strtotime($lpk->tgl_delivery) ? date('d-m-Y', strtotime($lpk->tgl_delivery)) : $lpk->tgl_delivery) : $lpk->tgl_delivery->format('d-m-Y')) : '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Nama Supplier</div>
                            <div class="font-medium"><?php echo e($lpk->nama_supply ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Nama Part</div>
                            <div class="font-medium"><?php echo e($lpk->nama_part ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Nomor PO</div>
                            <div class="font-medium"><?php echo e($lpk->nomor_po ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Nomor Part</div>
                            <div class="font-medium"><?php echo e($lpk->nomor_part ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Status LPK</div>
                            <div class="font-medium"><?php echo e($lpk->status ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Jenis LPK</div>
                            <div class="font-medium"><?php echo e($lpk->jenis_ng ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Kategori</div>
                            <div class="font-medium"><?php echo e($lpk->kategori ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Perlakuan Terhadap Part</div>
                            <div class="font-medium"><?php echo e($lpk->perlakuan_terhadap_part ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Frekuensi Claim</div>
                            <div class="font-medium"><?php echo e($lpk->frekuensi_claim ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Perlakuan Part Defect</div>
                            <div class="font-medium"><?php echo e($lpk->perlakuan_part_defect ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Lokasi Penemuan Claim</div>
                            <div class="font-medium"><?php echo e($lpk->lokasi_penemuan_claim ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Status Part Claim</div>
                            <div class="font-medium"><?php echo e($lpk->status_repair ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Gambar</div>
                            <div class="mt-1">
                                <?php if(!empty($lpk->gambar)): ?>
                                    <a href="<?php echo e($lpk->gambar); ?>" target="_blank" class="inline-block">
                                        <img src="<?php echo e($lpk->gambar); ?>" alt="LPK image" class="w-28 h-16 object-cover rounded border" />
                                    </a>
                                <?php else: ?>
                        ...
                        <div class="md:col-span-2 lg:col-span-3">
                            ...
                            <div class="mt-1 text-sm text-gray-700 max-h-20 overflow-hidden"><?php echo $lpk->problem ? nl2br(e($lpk->problem)) : '-'; ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Total Check</div>
                            <div class="font-medium"><?php echo e($lpk->total_check ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Total NG</div>
                            <div class="font-medium"><?php echo e($lpk->total_ng ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Total Delivery</div>
                            <div class="font-medium"><?php echo e($lpk->total_delivery ?? '-'); ?></div>
                        </div>

                        <div>
                            <div class="text-xs text-gray-500">Total Claim</div>
                            <div class="font-medium"><?php echo e($lpk->total_claim ?? '-'); ?></div>
                        </div>
                    </div>
                </div>

                <form action="<?php echo e(route('ppchead.lpk.ppcForm.store', $lpk->id ?? 0)); ?>" method="POST" id="ppc-form">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 mb-6">
                            <div>
                                ...
                                <select name="ppc_perlakuan_terhadap_part" required
                                    ...
                                    <option value="Sortir oleh Supplier" <?php echo e((old('ppc_perlakuan_terhadap_part', $lpk->ppc_perlakuan_terhadap_part ?? '') == 'Sortir oleh Supplier') ? 'selected' : ''); ?>>Sortir oleh Supplier</option>
                                    <option value="Sortir Oleh PT KYBI" <?php echo e((old('ppc_perlakuan_terhadap_part', $lpk->ppc_perlakuan_terhadap_part ?? '') == 'Sortir Oleh PT KYBI') ? 'selected' : ''); ?>>Sortir Oleh PT KYBI</option>
                                    <option value="Part Tetap Dipakai" <?php echo e((old('ppc_perlakuan_terhadap_part', $lpk->ppc_perlakuan_terhadap_part ?? '') == 'Part Tetap Dipakai') ? 'selected' : ''); ?>>Part Tetap Dipakai</option>
                                </select>
                                <?php $__errorArgs = ['ppc_perlakuan_terhadap_part'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="ppc_perlakuan_terhadap_claim" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">-- Pilih --</option>
                                    <option value="pemotongan pembayaran" <?php echo e((old('ppc_perlakuan_terhadap_claim', $lpk->ppc_perlakuan_terhadap_claim ?? '') == 'pemotongan pembayaran') ? 'selected' : ''); ?>>pemotongan pembayaran</option>
                                    <option value="kirim pengganti" <?php echo e((old('ppc_perlakuan_terhadap_claim', $lpk->ppc_perlakuan_terhadap_claim ?? '') == 'kirim pengganti') ? 'selected' : ''); ?>>
                                        kirim pengganti</option>
                                </select>
                                <?php $__errorArgs = ['ppc_perlakuan_terhadap_claim'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?>
            ...
            try {
                ...
                btn.addEventListener('click', async function (e) {
                    ...
                    try {
                        ...
                        const approveUrl = '<?php echo e(route('ppchead.lpk.approve', $lpk->id ?? 0)); ?>';
                        ...
                        if (js.success) {
                            ...
                            window.location.href = '<?php echo e(route('ppchead.lpk.index')); ?>';
                            return;
                        } else {
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/ppchead/lpk/ppc_form.blade.php ENDPATH**/ ?>