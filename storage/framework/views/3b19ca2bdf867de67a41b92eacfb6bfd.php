...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> - Verifikasi OTP</title>
        ...
        <div class="glass-card rounded-3xl p-6">
            ...
            <div class="flex justify-center mb-4">
                <div class="glass-logo">
                    <img src="<?php echo e(asset('image/kayaba.webp')); ?>" class="w-24 object-contain">
                </div>
            </div>
            ...
            <?php if($errors->has('otp_code')): ?>
                <div class="mb-4 p-3 bg-red-50 border border-red-200 text-red-800 rounded"><?php echo e($errors->first('otp_code')); ?>
            ...
            <form method="POST" action="<?php echo e(route('otp.resend')); ?>" id="resend-form" class="mt-5 text-center">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/auth/otp-verification.blade.php ENDPATH**/ ?>