        ...
        <div class="m-0">
            <div
                ...
                <div class="p-6">
                    ...
                    <form id="filter-form" method="GET" action="<?php echo e(route('procurement.nqr.index')); ?>" class="mb-4">
                        <?php
                            $dateValue = '';
                            if (request('date')) {
                                try {
                                         ...
                                         <span
                                                                ...
                                                                <td class="px-3 py-3 text-center text-sm hidden sm:table-cell">
                                                                    <div class="flex items-center justify-center gap-1 action-buttons-container">
                                                                        <?php if($nqr->status_approval === 'Menunggu Approval Procurement'): ?>
                                                                            <div class="flex flex-col items-center">
                                                                                <button type="button"
                                                                                    data-url="<?php echo e(route('procurement.nqr.approve', $nqr->id)); ?>"
                                                                                    data-input-url="<?php echo e(route('procurement.nqr.inputPayCompensation', $nqr->id)); ?>"
                                                                            ...
                                                                            <div class="flex flex-col items-center">
                                                                                <button type="button"
                                                                                    data-url="<?php echo e(route('procurement.nqr.reject', $nqr->id)); ?>"
                                                                                    data-noreg="<?php echo e($nqr->no_reg_nqr); ?>"
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/procurement/nqr/index.blade.php ENDPATH**/ ?>