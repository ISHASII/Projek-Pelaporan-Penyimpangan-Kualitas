                        ...
                        <div class="rounded-md border border-gray-200 p-3 sm:p-4 bg-white shadow-sm">
                            ...
                            <div class="block lg:hidden space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2 pt-1">
                                    <button type="submit"
                                        class="inline-flex justify-center items-center px-3 py-1.5 bg-yellow-600 text-white text-sm font-medium rounded-md">Terapkan</button>
                                    <a href="<?php echo e(route('depthead.cmr.index')); ?>"
                            ...
                            <div class="hidden lg:flex gap-2 items-end">
                                ...
                                <div class="flex gap-2 items-center flex-shrink-0">
                                    <button type="submit"
                                        class="inline-flex items-center px-3 py-1.5 bg-yellow-600 text-white text-sm font-medium rounded-md">Terapkan</button>
                                    <a href="<?php echo e(route('depthead.cmr.index')); ?>"
                                                ...
                                                <div class="flex flex-col items-center justify-center gap-2">
                                                    <div class="flex items-center justify-center gap-4">
                                                        ...
                                                        <?php if(!is_null($cmr->requested_at_qc)): ?>
                                                            <div class="flex flex-col items-center gap-1">
                                                                <a href="<?php echo e(route('depthead.cmr.previewFpdf', $cmr->id)); ?>"
                                                                    target="_blank"
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto border rounded p-2 bg-white">
                    <?php $__empty_1 = true; $__currentLoopData = $agmApprovers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
