    ...
    <div class="m-0">
        <div class="bg-white rounded-none shadow-none overflow-hidden border-t-0 border-l-0 border-r-0 border-gray-100 w-full">
            <div class="p-6">
                ...
                <form id="filter-form" method="GET" action="<?php echo e(route('depthead.cmr.index')); ?>" class="mb-4">
                    <?php
                        $dateValue = '';
                        if (request('date')) {
                            try {
                    ...
                    <div class="rounded-md border border-gray-200 p-3 sm:p-4 bg-white shadow-sm">
                        ...
                        <div class="block lg:hidden space-y-2">
                            <div>
                                ...
                                <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari no reg, supplier, part..." class="mt-1 block w-full rounded-md border border-gray-300 bg-white text-sm px-2.5 py-1.5" />
                            </div>

                            <div class="grid grid-cols-2 gap-2">
                                <div>
                                    <label class="text-xs text-gray-600 font-medium">Tanggal</label>
                                    <input type="text" id="date-picker-cmr-mobile" name="date_display" value="<?php echo e($dateValue); ?>" placeholder="dd-mm-yyyy" readonly class="mt-1 block w-full rounded-md border border-gray-300 bg-white text-sm px-2.5 py-1.5" />
                                </div>
                                <div>
                                    <label class="text-xs text-gray-600 font-medium">Tahun</label>
                                    <select name="year" class="mt-1 block w-full rounded-md border border-gray-300 bg-white text-sm px-2.5 py-1.5">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <select name="product" class="mt-1 block w-full rounded-md border border-gray-300 bg-white text-sm px-2.5 py-1.5">
                                        <option value="">Semua</option>
                                ...
                                <div>
                                    ...
                                    <select name="approval_status" class="mt-1 block w-full rounded-md border border-gray-300 bg-white text-sm px-2.5 py-1.5">
                            ...
                            <div class="grid grid-cols-2 gap-2 pt-1">
                                <button type="submit" class="inline-flex justify-center items-center px-3 py-1.5 bg-yellow-600 text-white text-sm font-medium rounded-md">Terapkan</button>
                                <a href="<?php echo e(route('depthead.cmr.index')); ?>" class="inline-flex justify-center items-center px-3 py-1.5 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-md">Reset</a>
                            </div>
                        </div>
                        ...
                        <div class="hidden lg:flex gap-2 items-end">
                            <div class="flex-1 min-w-0">
                                ...
                                <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Search no reg, supplier, part, PO..." class="mt-1 block w-full rounded-md border border-gray-300 bg-white text-sm px-2.5 py-1.5" />
                            </div>

                            <div class="w-36">
                                <label class="text-xs text-gray-600 font-medium">Date</label>
                                <input type="text" id="date-picker-cmr" name="date_display" value="<?php echo e($dateValue); ?>" placeholder="dd-mm-yyyy" readonly class="mt-1 block w-full rounded-md border border-gray-300 bg-white text-sm px-2.5 py-1.5" />
                            </div>
                            ...
                            <div class="flex gap-2 items-center flex-shrink-0">
                                <button type="submit" class="inline-flex items-center px-3 py-1.5 bg-yellow-600 text-white text-sm font-medium rounded-md">Terapkan</button>
                                <a href="<?php echo e(route('depthead.cmr.index')); ?>" class="inline-flex items-center px-3 py-1.5 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-md">Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
                            ...
                            <thead class="bg-red-600 text-white">
                                <tr>
                                    <th class="px-3 py-2 text-left w-40">
                                        <span class="block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">No Reg</span>
                                        <span class="block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">(登録不要)</span>
                                    </th>
                                    <th class="px-3 py-2 text-left w-32">
                                        <span class="inline-block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">CMR ISSUE DATE</span>
                                        <span class="inline-block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">(発行日)</span>
                                    </th>
                                    <th class="px-3 py-2 text-left w-40">
                                        <span class="inline-block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">SUPPLIER NAME </span>
                                        <span class="inline-block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">(サプライヤ名) </span>
                                    </th>
                                    <th class="px-3 py-2 text-left w-40">
                                        <span class="block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">PART NAME</span>
                                        <span class="block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">(部品名)</span>
                                    </th>
                                    <th class="px-3 py-2 text-left w-32">
                                        <span class="inline-block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">PART NUMBER</span>
                                        <span class="inline-block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">(部品番号)</span>
                                    </th>
                                    <th class="px-3 py-2 text-left w-32">
                                        <span class="block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">PRODUCT</span>
                                        <span class="block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">(製品)</span>
                                    </th>
                                    <th class="px-3 py-2 text-left w-36">
                                        ...
                                        <span class="inline-block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent">ステータス承認</span>
                                    </th>
                                    <th class="px-3 py-2 text-center hidden sm:table-cell w-28">
                                        <span class="block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent rounded-tr-lg">Action</span>
                                        <span class="block px-2 py-1 text-sm font-medium text-white bg-transparent border border-transparent rounded-tr-lg">アクション</span>
                                    </th>
                                </tr>
                            </thead>
                                    ...
                                    <tr class="odd:bg-gray-100 even:bg-white hover:bg-gray-200 transition-colors" data-cmr-id="<?php echo e($cmr->id); ?>">
                                        ...
                                        <td class="px-3 py-3 text-sm text-gray-900 text-center">
                                            <?php
                                                ...
                                                if ($prod === 'SKA') { $badgeClass = 'bg-amber-100 text-amber-800'; }
                                                elseif ($prod === 'OCU') { $badgeClass = 'bg-blue-100 text-blue-800'; }
                                                elseif ($prod === 'FF') { $badgeClass = 'bg-green-100 text-green-800'; }
                                            ?>
                                            <span class="inline-flex items-center justify-center px-2 py-1 text-xs font-medium rounded-full <?php echo e($badgeClass); ?>"><?php echo e($prodText); ?></span>
                                        </td>
                                        <td class="px-3 py-3 text-sm text-gray-900 status-approval-cell">
                                            <?php
                                                // Prefer the explicit DB status_approval when present. This ensures
                                                // the index view matches the database state exactly (per request).
                                                $explicit = trim($cmr->status_approval ?? '');
                                                if (!empty($explicit)) {
                                                    $statusMsg = $explicit;
                                                } else {
                                        ...
                                        <td class="px-3 py-3 text-center text-sm hidden sm:table-cell action-buttons-container">
                                            <div class="flex flex-col items-center justify-center gap-2">
                                                <div class="flex items-center justify-center gap-4">
                                                    <?php $deptStatus = strtolower($cmr->depthead_status ?? 'pending'); ?>
                                                    <?php if(!is_null($cmr->requested_at_qc) && strtolower($cmr->secthead_status ?? '') === 'approved' && $deptStatus === 'pending'): ?>
                                                        <div class="flex flex-col items-center gap-1">
                                                            <button type="button"
                                                                class="open-approve-modal inline-flex items-center justify-center w-8 h-8 rounded-md hover:bg-green-50"
                                                                title="Setuju"
                                                                data-url="<?php echo e(route('depthead.cmr.approve', $cmr->id)); ?>"
                                                        ...
                                                        <div class="flex flex-col items-center gap-1">
                                                            <button type="button"
                                                                ...
                                                                title="Tolak"
                                                                data-url="<?php echo e(route('depthead.cmr.reject', $cmr->id)); ?>"
                                                                data-cmr-id="<?php echo e($cmr->id); ?>"
                                                                data-noreg="<?php echo e($cmr->no_reg); ?>">
                                                    ...
                                                    <?php if(!is_null($cmr->requested_at_qc)): ?>
                                                        <div class="flex flex-col items-center gap-1">
                                                            <a href="<?php echo e(route('depthead.cmr.previewFpdf', $cmr->id)); ?>" target="_blank" class="inline-flex items-center justify-center w-8 h-8 rounded-md hover:bg-gray-100" title="Preview PDF">
                    ...
                    <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                        <div class="flex items-center justify-between">
                            <nav class="flex items-center justify-center space-x-2 sm:justify-between w-full">
                                <?php $prev = $cmrs->previousPageUrl(); $next = $cmrs->nextPageUrl(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateRowAfterAction(cmrId, newStatus, hideActions) {
        ...
        if (hideActions) {
            ...
            if (actionCell) {
                actionCell.innerHTML = '<div class="flex flex-col items-center gap-1"><a href="<?php echo e(url("depthead/cmr")); ?>/' + cmrId + '/preview-fpdf" target="_blank" class="inline-flex items-center justify-center w-8 h-8 rounded-md hover:bg-gray-100" title="Preview PDF"><img src="<?php echo e(asset("icon/pdf.ico")); ?>" alt="PDF" class="w-4 h-4" /></a><span class="text-xs text-gray-500 mt-1">PDF</span></div>';
            }
        }
    }
            ...
            approveForm.addEventListener('submit', function(e) {
                ...
                .then(function(data) {
                    ...
                    if (data.success) {
                        ...
                        updateRowAfterAction(currentApproveCmrId, data.new_status || 'Waiting for AGM approval', data.hide_actions);
                    } else {
            ...
            rejectForm.addEventListener('submit', function(e) {
                ...
                .then(function(data) {
                    ...
                    if (data.success) {
                        ...
                        updateRowAfterAction(currentRejectCmrId, data.new_status || 'Rejected by Dept Head', data.hide_actions);
                    } else {
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/depthead/cmr/index.blade.php ENDPATH**/ ?>