    ...
    <div class="w-full m-0 p-0">
        <div class="bg-white rounded-b-lg shadow-sm overflow-hidden w-full">
            ...
            <div class="max-w-screen-xl mx-auto px-6 py-6">
                <form action="<?php echo e(route('foreman.nqr.store')); ?>" method="POST" enctype="multipart/form-data" id="nqr-form">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/foreman/nqr/create.blade.php ENDPATH**/ ?>