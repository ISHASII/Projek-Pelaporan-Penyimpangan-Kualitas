        ...
        <div class="m-0">
            <div
                ...
                <div class="p-6">
                    ...
                    <form id="filter-form" method="GET" action="<?php echo e(route('secthead.nqr.index')); ?>" class="mb-4">
                        <?php
                            $dateValue = '';
                            if (request('date')) {
                                try {
                        ...
                        <div class="rounded-md border border-gray-200 p-3 sm:p-4 bg-white shadow-sm">
                            ...
                            <div class="block lg:hidden space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <input type="text" id="date-picker-secthead-mobile" name="date_display"
                                ...
                                <div class="grid grid-cols-2 gap-2 pt-1">
                                    ...
                                    <a href="<?php echo e(route('secthead.nqr.index')); ?>"
                            ...
                            <div class="hidden lg:flex gap-2 items-end">
                                ...
                                <div class="w-36">
                                    <label class="text-xs text-gray-600 font-medium">Tanggal</label>
                                    <input type="text" id="date-picker-secthead" name="date_display"
                                        value="<?php echo e($dateValue); ?>" placeholder="dd-mm-yyyy" readonly
                                        class="mt-1 block w-full rounded-md border border-gray-300 bg-white text-sm px-2.5 py-1.5 focus:ring-1 focus:ring-yellow-500 focus:border-yellow-500" />
                                </div>
                                         ...
                                         <span
                                                                ...
                                                                <td class="px-3 py-3 text-center text-sm hidden sm:table-cell">
                                                                    <div class="flex items-center justify-center gap-1 action-buttons-container">
                                                                        <?php if($nqr->status_approval === 'Menunggu Approval Sect Head'): ?>
                                                                            <div class="flex flex-col items-center">
                                                                                <button type="button"
                                                                                    data-url="<?php echo e(route('secthead.nqr.approve', $nqr->id)); ?>"
                                                                            ...
                                                                            <div class="flex flex-col items-center">
                                                                                <button type="button"
                                                                                    data-url="<?php echo e(route('secthead.nqr.reject', $nqr->id)); ?>"
                                                                                    data-noreg="<?php echo e($nqr->no_reg_nqr); ?>"
                                                                        ...
                                                                        <?php if(
                                                                            ...
                                                                            <div class="flex flex-col items-center">
                                                                                <a href="<?php echo e(route('secthead.nqr.previewFpdf', $nqr->id)); ?>" target="_blank"
                ...
                <div class="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto border rounded p-2 bg-white">
                    <?php $__empty_1 = true; $__currentLoopData = $deptApprovers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $da): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                            <input type="checkbox" name="approve_recipients[]" value="<?php echo e($da->npk); ?>" class="approve-recipient-checkbox">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function initFlatpickr(fp) {
                ...
                ['#date-picker-secthead', '#date-picker-secthead-mobile'].forEach(function (selector) {
                ...
                if (filterForm) {
                    filterForm.addEventListener('submit', function () {
                        try {
                            var desktop = document.getElementById('date-picker-secthead');
                            var mobile = document.getElementById('date-picker-secthead-mobile');
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/secthead/nqr/index.blade.php ENDPATH**/ ?>