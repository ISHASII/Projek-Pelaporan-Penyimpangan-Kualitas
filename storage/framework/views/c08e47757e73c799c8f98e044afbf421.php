    ...
    <div class="w-full m-0 p-0">
        <div class="bg-white rounded-b-lg shadow-sm overflow-hidden w-full">
            ...
            <div class="max-w-screen-xl mx-auto px-6 py-6">
                <form action="<?php echo e(route('qc.cmr.update', $cmr->id)); ?>" method="POST" enctype="multipart/form-data"
                    id="cmr-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-compact">
                        <div class="mb-6">
                            ...
                            <input type="text" id="no_reg_display" value="<?php echo e($cmr->no_reg ?? '-'); ?>" readonly
                                class="w-full border rounded-lg px-3 py-2 text-sm bg-gray-100 text-gray-600 cursor-not-allowed">
                            <input type="hidden" name="no_reg" value="<?php echo e($cmr->no_reg); ?>">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <input type="hidden" name="tgl_terbit_cmr" id="tgl_terbit_cmr"
                                    value="<?php echo e($cmr->tgl_terbit_cmr ? \Carbon\Carbon::parse($cmr->tgl_terbit_cmr)->format('Y-m-d') : ''); ?>"
                                    required>
                                <input type="text" name="tgl_terbit_cmr_display" id="tgl_terbit_cmr_display"
                                    ...
                                    value="<?php echo e($cmr->tgl_terbit_cmr ? \Carbon\Carbon::parse($cmr->tgl_terbit_cmr)->format('d-m-Y') : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="hidden" name="tgl_delivery" id="tgl_delivery"
                                    value="<?php echo e($cmr->tgl_delivery ? \Carbon\Carbon::parse($cmr->tgl_delivery)->format('Y-m-d') : ''); ?>"
                                    required>
                                <input type="text" name="tgl_delivery_display" id="tgl_delivery_display" inputmode="numeric"
                                    ...
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="<?php echo e($cmr->tgl_delivery ? \Carbon\Carbon::parse($cmr->tgl_delivery)->format('d-m-Y') : ''); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <input type="hidden" name="bl_date" id="bl_date"
                                    value="<?php echo e($cmr->bl_date ? \Carbon\Carbon::parse($cmr->bl_date)->format('Y-m-d') : ''); ?>">
                                <input type="text" name="bl_date_display" id="bl_date_display" inputmode="numeric"
                                    pattern="\d{2}-\d{2}-\d{4}" placeholder="dd-mm-yyyy"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="<?php echo e($cmr->bl_date ? \Carbon\Carbon::parse($cmr->bl_date)->format('d-m-Y') : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="hidden" name="ar_date" id="ar_date"
                                    value="<?php echo e($cmr->ar_date ? \Carbon\Carbon::parse($cmr->ar_date)->format('Y-m-d') : ''); ?>">
                                <input type="text" name="ar_date_display" id="ar_date_display" inputmode="numeric"
                                    pattern="\d{2}-\d{2}-\d{4}" placeholder="dd-mm-yyyy"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="<?php echo e($cmr->ar_date ? \Carbon\Carbon::parse($cmr->ar_date)->format('d-m-Y') : ''); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <input type="hidden" name="found_date" id="found_date"
                                    value="<?php echo e($cmr->found_date ? \Carbon\Carbon::parse($cmr->found_date)->format('Y-m-d') : ''); ?>">
                                <input type="text" name="found_date_display" id="found_date_display" inputmode="numeric"
                                    pattern="\d{2}-\d{2}-\d{4}" placeholder="dd-mm-yyyy"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="<?php echo e($cmr->found_date ? \Carbon\Carbon::parse($cmr->found_date)->format('d-m-Y') : ''); ?>">
                            ...
                            <div>
                                ...
                                <div id="supplier_dropdown" class="relative" data-suppliers='<?php echo json_encode($suppliers, 15, 512) ?>'>
                                    ...
                                    <button type="button" id="nama_supplier_btn"
                                        ...
                                        <span><?php echo e(old('nama_supplier', $cmr->nama_supplier) ? old('nama_supplier', $cmr->nama_supplier) : 'Pilih Supplier'); ?></span>
                                    </button>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">PART (部品)<span
                                        class="text-red-500">*</span></label>
                                <div id="part_dropdown" class="relative" data-items='<?php echo json_encode($items->map(function ($i) {
                                    return ["kode" => $i->kode, "desc" => $i->description];
                                }), 512) ?>'>
                                    <input type="hidden" name="nomor_part"
                                        value="<?php echo e(old('nomor_part', $cmr->nomor_part)); ?>">
                                    <input type="hidden" name="nama_part" value="<?php echo e(old('nama_part', $cmr->nama_part)); ?>"
                                        required>
                                    <button type="button" id="nomor_part_btn"
                                        class="w-full text-left border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                        <span><?php echo e(old('nomor_part', $cmr->nomor_part) ? (old('nomor_part', $cmr->nomor_part) . ' — ' . old('nama_part', $cmr->nama_part)) : 'Pilih Part'); ?></span>
                                    </button>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            <label class="block text-xs font-semibold text-gray-700 mb-1">PO NUMBER (注文番号)<span
                                    class="text-red-500">*</span></label>
                            <input name="nomor_po" value="<?php echo e($cmr->order_no); ?>" required
                                class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">INVOICE NO (請求書番号)<span
                                        class="text-red-500">*</span></label>
                                <input name="invoice_no" value="<?php echo e($cmr->invoice_no); ?>" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">ORDER NO (|オーダーNo.) <span
                                        class="text-red-500">*</span></label>
                                <input name="order_no" value="<?php echo e($cmr->order_no); ?>" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <select name="product" required
                                    ...
                                    <option value="SKA" <?php echo e($cmr->product == 'SKA' ? 'selected' : ''); ?>>SKA</option>
                                    <option value="FF" <?php echo e($cmr->product == 'FF' ? 'selected' : ''); ?>>FF</option>
                                    <option value="OCU" <?php echo e($cmr->product == 'OCU' ? 'selected' : ''); ?>>OCU</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input name="model" value="<?php echo e(old('model', $cmr->model)); ?>"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    placeholder="Model">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input name="crate_number" value="<?php echo e(old('crate_number', $cmr->crate_number)); ?>"
                                        class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <select name="location_claim_occurrence" id="lokasi_penemuan_claim" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="Receiving Inspect" <?php echo e($cmr->location_claim_occurrence == 'Receiving Inspect' ? 'selected' : ''); ?>>Receiving Inspect (受入检查)</option>
                                    <option value="In-Process" <?php echo e($cmr->location_claim_occurrence == 'In-Process' ? 'selected' : ''); ?>>In-Process (工程内)</option>
                                    <option value="Customer" <?php echo e($cmr->location_claim_occurrence == 'Customer' ? 'selected' : ''); ?>>Customer (客先)</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <select name="disposition_inventory_type" id="disposition_inventory_type" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="AT CUSTOMER" <?php echo e($cmr->disposition_inventory_type == 'AT CUSTOMER' ? 'selected' : ''); ?>>AT CUSTOMER (客先にて)</option>
                                    <option value="AT PT.KYBI" <?php echo e($cmr->disposition_inventory_type == 'AT PT.KYBI' ? 'selected' : ''); ?>>AT PT.KYBI (PT KYB にて)</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <select name="claim_occurrence_frequency" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="First time" <?php echo e($cmr->claim_occurrence_frequency == 'First time' ? 'selected' : ''); ?>>First time (初回)</option>
                                    <option value="Reoccurred" <?php echo e($cmr->claim_occurrence_frequency == 'Reoccurred' ? 'selected' : ''); ?>>Reoccurred (再発)</option>
                                    <option value="Intermittently" <?php echo e($cmr->claim_occurrence_frequency == 'Intermittently' ? 'selected' : ''); ?>>Intermittently (断統的)</option>
                                    <option value="Continuously" <?php echo e($cmr->claim_occurrence_frequency == 'Continuously' ? 'selected' : ''); ?>>Continuously (總統的)</option>
                                    <option value="Other" <?php echo e($cmr->claim_occurrence_frequency == 'Other' ? 'selected' : ''); ?>>
                                        Other (その他)</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
                            ...
                            <div>
                                ...
                                <select name="dispatch_defective_parts" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="Dispatch with this report" <?php echo e($cmr->dispatch_defective_parts == 'Dispatch with this report' ? 'selected' : ''); ?>>Dispatch with this report (本レポートと共に送付)
                                    </option>
                                    <option value="Dispatch separately" <?php echo e($cmr->dispatch_defective_parts == 'Dispatch separately' ? 'selected' : ''); ?>>Dispatch separately (別途送付)</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                ...
                                <select name="disposition_defect_parts" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">--Choose --</option>
                                    <option value="Keep to use" <?php echo e($cmr->disposition_defect_parts == 'Keep to use' ? 'selected' : ''); ?>>Keep to use (總統使用)</option>
                                    <option value="Return to KYB" <?php echo e($cmr->disposition_defect_parts == 'Return to KYB' ? 'selected' : ''); ?>>Return to KYB (KYB 返却)</option>
                                    <option value="Scrapped at PT.KYB" <?php echo e($cmr->disposition_defect_parts == 'Scrapped at PT.KYB' ? 'selected' : ''); ?>>Scrapped at PT.KYB (PTKYB にて廃却)</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">QTY ORDER (注文数量)<span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="qty_order" value="<?php echo e(old('qty_order', $cmr->qty_order)); ?>"
                                    required min="0"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">QTY DELIVERED (納品数量)<span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="qty_deliv" value="<?php echo e($cmr->qty_deliv); ?>" required min="0"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
                            <div>
                                <label class="block text-xs font-semibold text-gray-700 mb-1">QTY PROBLEM (数量の問題)<span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="qty_problem" value="<?php echo e($cmr->qty_problem); ?>" required min="0"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                            ...
                            <div>
                                ...
                                <?php if($cmr->gambar): ?>
                                    ...
                                    <div id="existing-image" class="mt-2 relative inline-block">
                                        <img src="<?php echo e($imgSrc); ?>" alt="current"
                        ...
                        <div class="mb-6">
                            ...
                            <input name="input_problem" id="input_problem" value="<?php echo e($cmr->input_problem); ?>" type="text"
                                maxlength="75"
                                class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
            ...
            try {
                ...
                function renderChoices() {
                    ...
                    if (options[val]) options[val].forEach(o => {
                        ...
                        if (el.value === "<?php echo e(old('disposition_inventory_choice', $cmr->disposition_inventory_choice)); ?>") el.selected = true;
