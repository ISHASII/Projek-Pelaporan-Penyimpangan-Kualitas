<?php $__env->startSection('content'); ?>
    ...
    <div id="request-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40">
        <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6">
            ...
            <div class="mb-4">
                <p class="text-sm text-gray-600 mb-2">Pilih Foreman yang ingin menerima email request (centang salah satu atau beberapa):</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-48 overflow-y-auto border rounded p-2 bg-white">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-2 text-sm text-gray-500 italic">Tidak ada approver Foreman QA yang tersedia.</div>
                    <?php endif; ?>
                </div>
