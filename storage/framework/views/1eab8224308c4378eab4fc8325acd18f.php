...
<style>
    body {
        background:
            ...
            url('<?php echo e(asset("image/PT.webp")); ?>');
        ...
        <div class="glass-card rounded-3xl p-6">
            <div class="flex justify-center">
                <div class="glass-logo">
                    <img src="<?php echo e(asset('image/kayaba.webp')); ?>" alt="KYB" class="w-24 md:w-28 object-contain">
                </div>
            </div>

            <form method="POST" action="<?php echo e(url('/login')); ?>" novalidate class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
                    <label for="npk" class="glass-label block text-sm mb-1.5">NPK</label>
                    <input id="npk" type="text" name="npk" value="<?php echo e(old('npk')); ?>" autofocus placeholder="Masukkan NPK"
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="text-red-600 text-sm mt-1 font-medium"><?php echo e($message); ?></p>
                    <?php unset($message);
                ...
                <div>
                    ...
                    <div class="glass-pw-wrapper flex overflow-hidden rounded-xl transition-all duration-300">
                        ...
                        <button type="button" id="toggle-password"
                            ...
                            <img id="eye-icon" src="<?php echo e(asset('icon/show.ico')); ?>" alt="show password"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3 mb-2">
                        <img src="<?php echo e(captcha_src('flat')); ?>" alt="Kode captcha - klik untuk refresh" id="captcha-img"
                        ...
                        <button type="button" id="refresh-captcha"
                            ...
                            <img src="<?php echo e(asset('icon/refresh.ico')); ?>" alt="Refresh Captcha" class="w-4 h-4">
                        </button>
                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-white text-xs mt-3">
                © <?php echo e(date('Y')); ?> PT Kayaba Indonesia
            </p>
        </div>
    </main>
    ...
    <script>
        function refreshCaptcha() {
            ...
            img.src = '<?php echo e(captcha_src("flat")); ?>' + '?_=' + Date.now();
        }

        function togglePassword() {
            const passwordInput = document.getElementById('password');
            const eyeIcon = document.getElementById('eye-icon');
            const showSrc = '<?php echo e(asset("icon/show.ico")); ?>';
            const hideSrc = '<?php echo e(asset("icon/hide.ico")); ?>';
...
</html><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/auth/login.blade.php ENDPATH**/ ?>