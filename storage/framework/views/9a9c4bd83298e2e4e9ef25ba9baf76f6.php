        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
                <div class="lg:col-span-1 flex flex-col gap-4">
                    ...
                    <div
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <div
                                ...
                                <img src="<?php echo e(asset('image/shopping-cart.png')); ?>" alt="CMR Icon"
                                    class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 object-contain">
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-xl shadow-sm border border-blue-500 p-3 sm:p-4 md:p-6 md:h-auto lg:h-auto overflow-y-auto">
