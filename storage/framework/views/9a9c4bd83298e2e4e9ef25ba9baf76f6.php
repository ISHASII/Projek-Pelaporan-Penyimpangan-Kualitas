        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
                <div class="lg:col-span-1 flex flex-col gap-4">
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-lg sm:text-xl md:text-2xl font-bold text-blue-600">
                                    <?php echo e(number_format($nqrStats['total'] ?? 0)); ?></p>
                    ...
                    <div
                        class="bg-white rounded-xl shadow-sm border border-blue-500 p-3 sm:p-4 md:p-6 md:h-72 lg:h-80 overflow-y-auto">
                        ...
                        <div class="space-y-2 sm:space-y-3 mt-8 sm:mt-10">
                            <div class="flex items-center justify-between p-2 sm:p-3 md:p-4 bg-green-100 rounded-lg">
                                ...
                                <span
                                    class="text-xs sm:text-sm font-bold text-green-600"><?php echo e($nqrStats['completed'] ?? 0); ?></span>
                            </div>
                            <div class="flex items-center justify-between p-2 sm:p-3 md:p-4 bg-yellow-100 rounded-lg">
                                ...
                                <span
                                    class="text-xs sm:text-sm font-bold text-yellow-600"><?php echo e($nqrStats['pending'] ?? 0); ?></span>
                            </div>
                            <div class="flex items-center justify-between p-2 sm:p-3 md:p-4 bg-red-100 rounded-lg">
                                ...
                                <span
                                    class="text-xs sm:text-sm font-bold text-red-600"><?php echo e($nqrStats['rejected'] ?? 0); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/vdd/dashboard.blade.php ENDPATH**/ ?>