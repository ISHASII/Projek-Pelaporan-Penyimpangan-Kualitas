    ...
    <div class="w-full m-0 p-0">
        <div class="bg-white rounded-b-lg shadow-sm overflow-hidden w-full">
            <div class="max-w-screen-md mx-auto px-6 py-6">
                <form action="<?php echo e($formAction ?? route('procurement.cmr.storeCompensation', $cmr->id)); ?>" method="POST"
                    id="compensation-form">
                    <?php echo csrf_field(); ?>
                    <div class="bg-white border border-gray-300 rounded-lg overflow-hidden">
                        <div class="bg-red-600 px-6 py-4">
                            <h1 class="text-white text-lg font-semibold">Input Pay Compensation
                                (<?php echo e($roleLabel ?? 'Procurement'); ?>)</h1>
                        </div>

                        <div class="px-6 pt-6 flex items-center gap-3">
                            <a href="<?php echo e($backRoute ?? route('procurement.cmr.index')); ?>"
                            ...
                            <a href="<?php echo e($previewRoute ?? route('procurement.cmr.previewFpdf', $cmr->id)); ?>" target="_blank"
                                rel="noopener"
