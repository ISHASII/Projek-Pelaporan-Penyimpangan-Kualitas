                        ...
                        <div class="p-6">
                            <div class="mb-4">
                                ...
                                <select name="ppc_disposition" id="ppc-disposition" required
                                    ...
                                    <option value="pay_compensation" <?php echo e($ppc_disposition_val === 'pay_compensation' ? 'selected' : ''); ?>>Pay Compensation</option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- Currency Symbol Field (Manual Input) -->
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="pay_compensation_field" style="display: none;" class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Pay Compensation <span
                                        class="text-red-500">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="send_replacement_field" style="display: none;" class="mb-4">
                                ...
                                <select name="ppc_shipping" id="ppc_shipping"
                                    class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                    <option value="">-- Choose --</option>
                                    <option value="AIR" <?php echo e($ppc_shipping_val === 'AIR' ? 'selected' : ''); ?>>By Air</option>
                                    <option value="SEA" <?php echo e($ppc_shipping_val === 'SEA' ? 'selected' : ''); ?>>By Sea</option>
                                </select>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                payCompensationDisplay && payCompensationDisplay.addEventListener('input', function (e) {
                    ...
                    // keep numeric raw value in hidden input
                ...
                function toggleField() {
                    ...
                    } else if (value === 'pay_compensation') {
