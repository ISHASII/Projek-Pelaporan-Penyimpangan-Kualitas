    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const recipientsSelectAll = document.getElementById('recipients-select-all');

                // Recipients select all functionality
                if (recipientsSelectAll) {
                    recipientsSelectAll.addEventListener('change', function() {
                        document.querySelectorAll('#request-modal .recipient-checkbox').forEach(function(cb) {
                            cb.checked = recipientsSelectAll.checked;
                        });
                    });
                }
                ...
                document.querySelectorAll('.open-request-modal').forEach(btn => {
                    btn.addEventListener('click', function () {
                        ...
                        if (recipientsSelectAll) recipientsSelectAll.checked = false;
                        document.querySelectorAll('#request-modal .recipient-checkbox').forEach(function(cb) {
                            cb.checked = false;
                        });
                        const url = this.getAttribute('data-url');
                ...
                if (requestConfirmBtn) {
                    requestConfirmBtn.addEventListener('click', function (e) {
                        ...
                        document.querySelectorAll('#request-modal .recipient-checkbox:checked').forEach(function(cb) {
