        ...
        <div class="m-0">
            <div
                ...
                <div class="p-6">
                    ...
                    <form id="filter-form" method="GET" action="<?php echo e(route('ppchead.lpk.index')); ?>" class="mb-4">
                        <?php
                        ...
                        <div class="rounded-md border border-gray-200 p-3 sm:p-4 bg-white shadow-sm">
                            ...
                            <div class="block lg:hidden space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2 pt-1">
                                    ...
                                    <a href="<?php echo e(route('ppchead.lpk.index')); ?>"
                            ...
                            <div class="hidden lg:flex gap-2 items-end">
                                ...
                                <div class="w-36">
                                    ...
                                    <select name="status_lpk"
                                        ...
                                        <option value="complaint" <?php echo e(request('status_lpk') == 'complaint' ? 'selected' : ''); ?>>Complaint (Informasi)</option>
                                    </select>
                                </div>
                    ...
                    <div class="mt-6 responsive-table overflow-x-auto rounded-md ring-1 ring-gray-50">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 table-fixed">
                                <thead class="bg-red-600 text-white">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-center hidden sm:table-cell w-36">
                                            <span
                                ...
                                <tbody class="bg-gray-50 divide-y divide-gray-200">
                                    <?php $__currentLoopData = $lpks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lpk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="<?php echo e($loop->even ? 'bg-gray-100' : 'bg-white'); ?> hover:bg-gray-200 transition-colors"
                                            data-lpk-id="<?php echo e($lpk->id); ?>">
                                            <td class="px-4 py-4 text-sm text-gray-900"><?php echo e($lpk->no_reg ?? $lpk->id); ?></td>
                                            <td class="px-4 py-4 text-sm text-gray-600">
                                                <?php echo e($lpk->tgl_terbit ? (is_string($lpk->tgl_terbit) ? (strtotime($lpk->tgl_terbit) ? date('d-m-Y', strtotime($lpk->tgl_terbit)) : $lpk->tgl_terbit) : $lpk->tgl_terbit->format('d-m-Y')) : (optional($lpk->created_at)->format('d-m-Y') ?? '-')); ?>

                                            </td>
                                            <td class="px-4 py-4 text-sm text-gray-600"><?php echo e($lpk->nama_supply ?? '-'); ?></td>
                                            <td class="px-4 py-4 text-sm text-gray-600"><?php echo e($lpk->nama_part ?? '-'); ?></td>
                                            <td class="px-4 py-4 text-sm text-gray-600"><?php echo e($lpk->nomor_part ?? '-'); ?></td>
                                            ...
                                            <td class="px-4 py-4 text-sm text-gray-900 status-approval-cell">
                                                <?php
                                            ...
                                            <td class="px-4 py-4 text-center text-sm hidden sm:table-cell">
                                                <div class="flex flex-col items-center justify-center gap-2">
                                                    <div class="flex items-center justify-center gap-4">
                                                        <?php
                                                            ...
                                                            $dept = strtolower($lpk->depthead_status ?? 'pending');
                                                            $ppc = strtolower($lpk->ppchead_status ?? 'pending');
                                                            $ppcComplete = !empty($lpk->ppc_perlakuan_terhadap_part) && !empty($lpk->ppc_perlakuan_terhadap_claim);
                                                        ?>
                                                        <div class="flex flex-col items-center justify-center gap-2">
                                                            <!-- Tombol aksi: Approve, PDF, Reject sejajar -->
                                                            <div
                                                                class="flex flex-row items-center justify-center gap-6 action-buttons-container">
                                                                <?php if(!is_null($lpk->requested_at_qc) && $sect === 'approved' && $dept === 'approved' && $ppc === 'pending'): ?>
                                                                    <div class="flex flex-col items-center gap-1 approve-btn-wrapper">
                                                                        <a href="<?php echo e(route('ppchead.lpk.ppcForm', $lpk->id)); ?>"
                                                                            class="approve-link inline-flex items-center justify-center w-8 h-8 rounded-md hover:bg-green-50 transition"
                                                                            title="Approve">
                                                                ...
                                                                <?php endif; ?>
                                                                <?php if(!is_null($lpk->requested_at_qc) && $sect === 'approved' && $dept === 'approved' && $ppc === 'pending'): ?>
                                                                    <div class="flex flex-col items-center gap-1 reject-btn-wrapper">
                                                                        <button type="button"
                                                                            class="open-reject-modal inline-flex items-center justify-center w-8 h-8 rounded-md hover:bg-red-50 transition"
                                                                            title="Tolak"
                                                                            data-url="<?php echo e(route('ppchead.lpk.reject', $lpk->id)); ?>"
                                                                ...
                                                                <?php if(!is_null($lpk->requested_at_qc)): ?>
                                                                    <div class="flex flex-col items-center gap-1">
                                                                        <a href="<?php echo e(route('ppchead.lpk.previewPdf', $lpk->id)); ?>"
                                                                            target="_blank"
                                                                            class="inline-flex items-center justify-center w-8 h-8 rounded-md hover:bg-gray-100 transition"
                                                                            title="Preview PDF">
                                                                            <img src="<?php echo e(asset('icon/pdf.ico')); ?>" alt="PDF"
                                                                                class="w-4 h-4" />
                                                                        </a>
                            ...
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                                <div class="text-sm text-gray-600">
                                    Menampilkan <span class="font-medium"><?php echo e($lpks->firstItem() ?? 0); ?></span> - <span
                                        ...
                                        class="font-medium"><?php echo e($lpks->total()); ?></span>
                                </div>
...
<!-- Approve and Reject modals for PPC Head -->
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function hideActionButtons(lpkId) {
            ...
            if (row) {
                ...
                if (actionContainer) {
                    // Remove approve button wrapper
                    const approveWrapper = actionContainer.querySelector('.approve-btn-wrapper');
                    if (approveWrapper) approveWrapper.remove();

                    // Remove reject button wrapper
                    const rejectWrapper = actionContainer.querySelector('.reject-btn-wrapper');
                    if (rejectWrapper) rejectWrapper.remove();
                }
            }
        }
        ...
        document.querySelectorAll('.open-approve-modal').forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                if (!ppcComplete && ppcUrl) {
                    ...
                    ppcRedirectCancel.onclick = function () { ppcRedirectModal.classList.add('hidden'); ppcRedirectModal.classList.remove('flex'); };
                    ppcRedirectModal.classList.remove('hidden'); ppcRedirectModal.classList.add('flex');
                    return;
                }

                approveForm.setAttribute('action', url);
                approveMsg.textContent = 'Apakah Anda yakin ingin menyetujui LPK ' + noreg + '?';
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        if (currentLpkId) {
                            updateRowStatus(currentLpkId, data.newStatusText || 'Selesai');
        ...
        document.querySelectorAll('.open-reject-modal').forEach(btn => {
            btn.addEventListener('click', function () {
                const url = this.getAttribute('data-url');
                const noreg = this.getAttribute('data-noreg');
                currentRejectLpkId = this.getAttribute('data-lpk-id');
                rejectForm.setAttribute('action', url);
                rejectMsg.textContent = 'Apakah Anda yakin ingin menolak LPK ' + noreg + '?';
                rejectModal.classList.remove('hidden'); rejectModal.classList.add('flex');
            });
        });
            ...
            fetch(url, {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        if (currentRejectLpkId) {
                            updateRowStatus(currentRejectLpkId, data.newStatusText || 'Ditolak PPC Head');
                            hideActionButtons(currentRejectLpkId);
                        }
                    } else {
                        showToast(data.message || 'Terjadi kesalahan', 'error');
                    }
        ...
        rejectCancel.addEventListener('click', function () { rejectModal.classList.add('hidden'); rejectModal.classList.remove('flex'); });
        rejectModal.addEventListener('click', function (e) { if (e.target === rejectModal) { rejectModal.classList.add('hidden'); rejectModal.classList.remove('flex'); } });
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
                    ...
                    fp(el, {
                        ...
                        onChange: function (selectedDates, dateStr) {
                            ...
                            if (selectedDates && selectedDates[0]) {
                                ...
                                if (m) { hidden.value = m[3] + '-' + m[2].padStart(2, '0') + '-' + m[1].padStart(2, '0'); }
                            }
                        }
                    });
                } catch (err) { console && console.error('flatpickr init error', err); }
            });

            // ensure form submit also syncs visible -> hidden
                ...
                filterForm.addEventListener('submit', function (e) {
                    try {
                        ...
                        if (m) {
                            ...
                            if (m2) {
                                hidden.value = m2[1] + '-' + String(m2[2]).padStart(2, '0') + '-' + String(m2[3]).padStart(2, '0');
                            } else {
                                hidden.value = val;
                            }
                        }
        ...
        // load local assets only (offline mode)
        if (window.flatpickr) { initFlatpickr(window.flatpickr); return; }
        ...
        s.onload = function () { if (window.flatpickr) initFlatpickr(window.flatpickr); };
        document.body.appendChild(s);
    });
</script>

<!-- PPC Redirect Modal (styled) -->
<div id="ppc-redirect-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/ppchead/lpk/index.blade.php ENDPATH**/ ?>