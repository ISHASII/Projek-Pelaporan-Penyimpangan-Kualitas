        ...
        <div class="bg-white rounded-b-lg shadow-sm overflow-hidden w-full">
            <div class="px-6 py-4 rounded-none">
                <div class="max-w-screen-xl mx-auto flex items-center">
                    <h1 class="text-red-600 text-lg font-semibold">Edit NQR</h1>
                </div>
            </div>

            <div class="max-w-screen-xl mx-auto px-6 py-6">
                <form action="<?php echo e(route('foreman.nqr.update', ['nqr' => $nqr->id])); ?>" method="POST"
                    enctype="multipart/form-data" id="nqr-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <!-- Nomor Registrasi NQR (Read-only) -->
                    <div class="mb-6">
                        <label class="block text-xs font-semibold text-gray-700 mb-1">NO REG</label>
                        <input type="text" value="<?php echo e($nqr->no_reg_nqr); ?>" readonly
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 mb-6">
                            ...
                            <div>
                                ...
                                <input type="hidden" name="tgl_terbit_nqr" id="tgl_terbit_nqr"
                                    value="<?php echo e(old('tgl_terbit_nqr', $nqr->tgl_terbit_nqr->format('Y-m-d'))); ?>" required>
                                <input type="text" id="tgl_terbit_nqr_display" inputmode="numeric"
                                    ...
                                    value="<?php echo e(old('tgl_terbit_nqr') ? date('d-m-Y', strtotime(old('tgl_terbit_nqr'))) : $nqr->tgl_terbit_nqr->format('d-m-Y')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="hidden" name="tgl_delivery" id="tgl_delivery"
                                    value="<?php echo e(old('tgl_delivery', $nqr->tgl_delivery->format('Y-m-d'))); ?>" required>
                                <input type="text" id="tgl_delivery_display" inputmode="numeric" pattern="\d{2}-\d{2}-\d{4}"
                                    placeholder="dd-mm-yyyy"
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    value="<?php echo e(old('tgl_delivery') ? date('d-m-Y', strtotime(old('tgl_delivery'))) : $nqr->tgl_delivery->format('d-m-Y')); ?>">
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 mb-6">
                            ...
                            <div id="supplier_dropdown" class="relative">
                                ...
                                <input type="hidden" name="nama_supplier" id="nama_supplier"
                                    value="<?php echo e(old('nama_supplier', $nqr->nama_supplier)); ?>" required>
                                <button type="button" id="nama_supplier_btn"
                                    ...
                                    <span
                                        id="nama_supplier_btn_text"><?php echo e(old('nama_supplier', $nqr->nama_supplier) ?: 'Pilih atau ketik nama supplier'); ?></span>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- Part (nomor_part searchable -> auto set nama_part) -->
                            <div id="part_dropdown" class="relative">
                                ...
                                <input type="hidden" name="nomor_part" id="nomor_part"
                                    value="<?php echo e(old('nomor_part', $nqr->nomor_part)); ?>" required>
                                <input type="hidden" name="nama_part" id="nama_part"
                                    value="<?php echo e(old('nama_part', $nqr->nama_part)); ?>">
                                <button type="button" id="nomor_part_btn"
                                    class="w-full text-left border rounded-lg px-3 py-2 text-sm flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-red-500">
                                    <span
                                        id="nomor_part_btn_text"><?php echo e((old('nomor_part', $nqr->nomor_part) ? old('nomor_part', $nqr->nomor_part) . ' — ' . old('nama_part', $nqr->nama_part) : 'Pilih atau cari nomor part')); ?></span>
                                    <img src="<?php echo e(asset('icon/dropdown.ico')); ?>" alt="dropdown" class="w-4 h-4">
                                </button>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_po" value="<?php echo e(old('nomor_po', $nqr->nomor_po)); ?>" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- (Removed duplicate plain NOMOR PART input; use the searchable part dropdown above) -->
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 mb-6">
                            ...
                            <div>
                                ...
                                <select name="status_nqr" required
                                    ...
                                    <option value="Claim" <?php echo e(old('status_nqr', $nqr->status_nqr) == 'Claim' ? 'selected' : ''); ?>>Claim</option>
                                    <option value="Complaint (Informasi)" <?php echo e(old('status_nqr', $nqr->status_nqr) == 'Complaint (Informasi)' ? 'selected' : ''); ?>>Complaint (Informasi)</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="location_claim_occur" required
                                    ...
                                    <option value="Receiving Insp" <?php echo e(old('location_claim_occur', $nqr->location_claim_occur) == 'Receiving Insp' ? 'selected' : ''); ?>>Receiving Insp
                                    </option>
                                    <option value="In-Process" <?php echo e(old('location_claim_occur', $nqr->location_claim_occur) == 'In-Process' ? 'selected' : ''); ?>>In-Process</option>
                                    <option value="Customer" <?php echo e(old('location_claim_occur', $nqr->location_claim_occur) == 'Customer' ? 'selected' : ''); ?>>Customer</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="border-t pt-4 mb-6">
                            <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-gray-700 mb-1">
                                        DISPOSITION OF INVENTORY <span class="text-red-500">*</span>
                                    </label>
                                    <select name="disposition_inventory_location" id="disposition_inventory_location"
                                        required
                                        class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                        <option value="">-- Pilih Location --</option>
                                        <option value="At Customer" <?php echo e(old('disposition_inventory_location', $nqr->disposition_inventory_location) == 'At Customer' ? 'selected' : ''); ?>>At
                                            Customer</option>
                                        <option value="At PT.KYBI" <?php echo e(old('disposition_inventory_location', $nqr->disposition_inventory_location) == 'At PT.KYBI' ? 'selected' : ''); ?>>At
                                            PT.KYBI</option>
                                    </select>
                                    <div class="error-message text-red-500 text-xs mt-1 hidden"
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 mb-6">
                            ...
                            <div>
                                ...
                                <select name="claim_occurence_freq" required
                                    ...
                                    <option value="First Time" <?php echo e(old('claim_occurence_freq', $nqr->claim_occurence_freq) == 'First Time' ? 'selected' : ''); ?>>First Time</option>
                                    <option value="Reoccurred/Routine" <?php echo e(old('claim_occurence_freq', $nqr->claim_occurence_freq) == 'Reoccurred/Routine' ? 'selected' : ''); ?>>
                                        Reoccurred/Routine</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="disposition_defect_part" required
                                    ...
                                    <option value="Keep to Use" <?php echo e(old('disposition_defect_part', $nqr->disposition_defect_part) == 'Keep to Use' ? 'selected' : ''); ?>>Keep to Use
                                    </option>
                                    <option value="Return to Supplier" <?php echo e(old('disposition_defect_part', $nqr->disposition_defect_part) == 'Return to Supplier' ? 'selected' : ''); ?>>Return to
                                        Supplier</option>
                                    <option value="Scrapped at PT.KYBI" <?php echo e(old('disposition_defect_part', $nqr->disposition_defect_part) == 'Scrapped at PT.KYBI' ? 'selected' : ''); ?>>Scrapped
                                        at PT.KYBI</option>
                                </select>
                                <div class="error-message text-red-500 text-xs mt-1 hidden"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="invoice" value="<?php echo e(old('invoice', $nqr->invoice)); ?>" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    placeholder="INVOICE">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="total_del" value="<?php echo e(old('total_del', $nqr->total_del)); ?>" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="total_claim" value="<?php echo e(old('total_claim', $nqr->total_claim)); ?>"
                                required
                                class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                        ...
                        <div class="mb-6">
                            ...
                            <?php if($nqr->gambar): ?>
                                <div class="mb-2" id="current-image-container">
                                    <div class="relative inline-block">
                                        <img src="<?php echo e(asset('storage/' . $nqr->gambar)); ?>" alt="Current Image"
                            ...
                            <?php else: ?>
                                <input type="file" name="gambar" id="gambar-input" accept="image/*" required
                                    class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                <p class="text-xs text-orange-600 mt-1">Tidak ada gambar saat ini. Gambar wajib diupload.</p>
                            <?php endif; ?>
                            ...
                            <div id="gambar-preview" class="mt-3 hidden">
                                ...
                                <p class="text-xs text-gray-600 mt-2">Preview gambar baru</p>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="detail_gambar" name="detail_gambar" rows="3" maxlength="265"
                                class="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                placeholder="Keterangan detail gambar (opsional)"><?php echo e(old('detail_gambar', $nqr->detail_gambar)); ?></textarea>
                            <div class="text-xs text-gray-500 mt-1 text-right">
                                <span
                                    id="detail_gambar_count"><?php echo e(strlen(old('detail_gambar', $nqr->detail_gambar))); ?></span>/265
                                karakter
                            </div>
                            <script>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex gap-3 justify-end">
                        <button type="submit"
                            ...
                            <img src="<?php echo e(asset('icon/edit.ico')); ?>" alt="save" class="w-4 h-4"
                                style="filter: brightness(0) invert(1);" />
                            <span>Update NQR</span>
                        </button>
                    </div>
                </form>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            (function attachCalendar() {
                ...
                function bind(fp) {
                    fields.forEach(({ hidden, display }) => {
                        ...
                        // ensure display input shows DB value when present
                        ...
                        fp(d, {
                            ...
                            onChange: function (selectedDates, dateStr) {
                                ...
                                if (parts.length === 3) {
                                    h.value = `${parts[2]}-${parts[1]}-${parts[0]}`; // yyyy-mm-dd
                                }
                            }
                        });
                    });
                ...
                // Load flatpickr from local vendor for offline use
            ...
            function setupDateInputFormatter(displayId, hiddenId) {
                ...
                displayInput.addEventListener('blur', function () {
                    const iso = toISO(displayInput.value.trim());
                    if (iso) {
            ...
            if (locationSelect.value) {
                ...
                const oldAction = "<?php echo e(old('disposition_inventory_action', $nqr->disposition_inventory_action)); ?>";
                if (oldAction) {
                    setTimeout(() => {
            ...
            // Ensure hidden ISO date fields are synced from visible display inputs
            ...
            if (submitBtn) {
                submitBtn.addEventListener('click', function (e) {
                    ...
                    // Sync visible date inputs into their hidden ISO fields so validation/submission receives them
                    try { syncHiddenFromDisplay(); } catch (err) { /* ignore */ }
            ...
            // Tombol hapus gambar baru (preview)
            const removeNewImageBtn = document.getElementById('remove-new-image');
            if (removeNewImageBtn && gambarInput && gambarPreview && gambarPreviewImg) {
            ...
            // Tombol hapus gambar lama (current)
            ...
            if (removeCurrentImageBtn && currentImageContainer && removeGambarFlag) {
                removeCurrentImageBtn.addEventListener('click', function () {
                    // Cek apakah ada gambar baru yang akan diupload
                    if (!gambarInput.files || gambarInput.files.length === 0) {
                        alert('Anda harus upload gambar baru terlebih dahulu sebelum menghapus gambar lama.\n\nGambar wajib ada dalam NQR.');
                        return;
                    }

                    if (confirm('Hapus gambar lama dan gunakan gambar baru?')) {
                        currentImageContainer.style.display = 'none';
                        removeGambarFlag.value = '1';
                    }
                });
            }
        });
    ...
    <script>
        // Searchable dropdown helpers (supplier and part) - same as create view
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/foreman/nqr/edit.blade.php ENDPATH**/ ?>