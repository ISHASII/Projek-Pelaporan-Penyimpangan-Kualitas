        ...
        let monthlyChart = new Chart(monthlyCtx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'NQR',
                        data: <?php echo json_encode($nqrSeries ?? []); ?>,
...
<?php echo $__env->make('layouts.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ilham\Documents\PROJEK-LPK\resources\views/foreman/dashboard.blade.php ENDPATH**/ ?>