        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto border rounded p-2 bg-white">
                    <?php $__empty_1 = true; $__currentLoopData = $procurementApprovers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function updateRowAfterAction(row, data) { /* same as procurement */
                    var statusCell = row.querySelector('.status-approval-cell');
                    if (statusCell && data.new_status) { statusCell.innerHTML = '<div class="font-medium leading-tight">' + data.new_status + '</div>'; }
                    if (data.hide_actions) {
                        ...
                        if (actionsContainer) {
                            ...
                            if (pdfLink) { var pdfParent = pdfLink.closest('.flex.flex-col'); actionsContainer.innerHTML = ''; if (pdfParent) actionsContainer.appendChild(pdfParent); } else { actionsContainer.innerHTML = '<span class="text-xs text-gray-400">Processed</span>'; }
                        }
                    }
                }
